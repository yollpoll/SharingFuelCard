...
public interface BuyCardService {
    @Multipart
    @POST(Url.BUY_CARD)
    Call<ResponseData<String>> buyCard(@Query("uid_card") String uid_card, @Query("actual_name") String actual_name,
                                       ...
                                       @Part("uploadFile\"; filename=\"IDCard_A\"") RequestBody IDCard_B);
}
